...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] bg-[radial-gradient(ellipse_at_center,_#232329_0%,_#050505_100%)] text-zinc-100 font-sans flex overflow-hidden selection:bg-blue-500/30">
      
      {/* GLOBAL NOISE TEXTURE */}
      <div className="fixed inset-0 pointer-events-none z-0 mix-blend-overlay opacity-30" style={{ backgroundImage: noiseBg }}></div>

      {/* LEFT SIDEBAR */}
      <aside className="hidden lg:flex w-64 flex-col border-r border-white/5 bg-[#050505]/80 backdrop-blur-md h-screen sticky top-0 relative z-10">
        <div className="p-6">
            <div className="flex items-center gap-3">
                ...
                <span className="font-bold text-xl tracking-tight">PromptWars</span>
            </div>
        </div>
      ...
      {/* CENTER STAGE */}
      <main className="flex-1 overflow-y-auto relative flex flex-col items-center p-4 md:p-8 z-10">
        <div className="lg:hidden w-full flex justify-between items-center mb-6">
            <div className="flex items-center gap-2 font-bold text-xl"><Swords size={20} /> PromptWars</div>
      ...
      {/* RIGHT SIDEBAR */}
      <aside className="hidden xl:flex w-80 flex-col border-l border-white/5 bg-[#050505]/80 backdrop-blur-md h-screen sticky top-0 p-6 overflow-y-auto relative z-10">
